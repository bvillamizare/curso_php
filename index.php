<?php
$nombre = 'beatriz';
$last_name = "Villamizar $nombre";
//https://ui-avatars.com/api/?name=John+Doe&size=255
//
...
$trabajos =
  [
    [
      'title' => 'PHP developer',
      'description' => 'it is a awesome job !!!'
      //esta es el indice 0 de jobs y su sub indice corresponde a title 
      //y descripcion se hace referencia al indice con =>
    ],
